...
To generate a set of 10^2, 10^3, 10^4, 10^5, and 10^6 sized input files, 
do the following:
...
5) Wait for the generator to complete. Exit the python interpreter.
    $ quit()
6) A new directory, 'randomly_generated_points/` will be in the project folder.
Files are accurately named to represent input size. Use them with the algorithms
in the syntax form specified earlier in the README.